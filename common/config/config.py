...
DEFAULT_SERVER_CONFIGS = [
    ...
    ServerConfig(server_id='server1', host='192.168.86.246', tcp_port=8000, heartbeat_port=8020, ring_position=1),
    ServerConfig(server_id='server2', host='192.168.86.246', tcp_port=8001, heartbeat_port=8021, ring_position=2),
    ServerConfig(server_id='server3', host='192.168.86.246', tcp_port=8002, heartbeat_port=8022, ring_position=3),
